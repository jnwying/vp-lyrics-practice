...
function closeInstallPrompt() {
    ...
    localStorage.setItem(
        "vpLyricsInstallPromptDismissed",
        "true"
    );
}
...
function checkInstallPrompt() {
    ...
    /*
       If the app is already running as a
       Home Screen web app, don't show the prompt.
    */
    ...
    /*
       Don't show it again if the user
